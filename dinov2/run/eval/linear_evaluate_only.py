...
from dinov2.eval.linear_evaluate_only import get_args_parser as get_linear_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.linear_evaluate_only import main as linear_main
